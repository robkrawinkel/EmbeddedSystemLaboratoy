...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../ESL_2D_camera_tracker.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../ESL_NIOS_II_system.sopcinfo
...
# Design Name 
# setting SOPC_NAME is ESL_NIOS_II_system
SOPC_NAME := ESL_NIOS_II_system
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x41440
SOPC_SYSID_FLAG += --sidp=0x41440
ELF_PATCH_FLAG  += --sidp 0x41440

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1623498729
SOPC_SYSID_FLAG += --timestamp=1623498729
ELF_PATCH_FLAG  += --timestamp 1623498729
